...
object MockKafkaServer {
  ...
  def main(args: Array[String]): Unit = {
    val normalKey = "zyKey"
    val stockData = "sh601006, 大慶提路, 27.55, 27.25, 26.91, 27.55, 26.20, 26.91, 26.92, 22114263, 589824680," +  Math.random() + "," + Math.random() + ", 57590, 26.90, 14700, 26.89, 14300, 26.88, 15100, 26.87, 3100, 26.92, 8900, 26.93, 14230, 26.94, 25150, 26.95, 15220, 26.96, 2008-01-11, 15:05:32"
    sendMessage(normalKey, stockData, 20000)
    mockConsumer
  }
}
